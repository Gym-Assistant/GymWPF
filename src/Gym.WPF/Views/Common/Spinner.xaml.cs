...
public class Spinner : Control
{
    ...
    public static readonly DependencyProperty EllipseDiameterTemplateSettingProperty =
        DependencyProperty.Register("EllipseDiameterTemplateSetting", typeof(double), typeof(Spinner), new PropertyMetadata(default(double)));
    ...
    public static readonly DependencyProperty EllipseOffsetTemplateSettingProperty =
        DependencyProperty.Register("EllipseOffsetTemplateSetting", typeof(Thickness), typeof(Spinner), new PropertyMetadata(default(Thickness)));

    /// <summary>
    /// Identifies the IsActive dependency property.
    /// </summary>
    public static readonly DependencyProperty IsActiveProperty =
        DependencyProperty.Register("IsActive", typeof(bool), typeof(Spinner), new PropertyMetadata(false, IsActiveChanged));
    ...
    public static readonly DependencyProperty MaxSideLengthTemplateSettingProperty =
        DependencyProperty.Register("MaxSideLengthTemplateSetting", typeof(double), typeof(Spinner), new PropertyMetadata(default(double)));
